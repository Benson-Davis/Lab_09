...
public class UserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<String> roleNames = convertRolesToStrings(rs.getAllRoles());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (editOrDelete != null) {
            ...
            if (editOrDelete.equals("Edit")) {
                ...
                //userInfo.setRole(rs.getRoleByID(Integer.parseInt(userInfo.getRole())));
    ...
    List<String> convertRolesToStrings(List<Role> roles)
    {
        RoleService rs = new RoleService();
        List<Role> allRoles = rs.getAllRoles();
        List<String> roleNames = new Vector<>();
        for(Role r : allRoles)
        {
